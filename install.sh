...
apt-get update -y
apt-get install -y python3-pip python3-venv python3.10-venv git wget curl supervisor ffmpeg software-properties-common sox
...
# torch 2.5.1+cu124 + numpy 1.26.4 requis pour compatibilite avec qwen-tts/transformers 4.57.3
