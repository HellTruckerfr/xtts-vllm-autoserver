...
echo ">>> Installation de Qwen3-TTS (repo officiel Alexandria-compatible)..."
cd /workspace
# Clone le repo officiel Qwen3-TTS qui expose l'interface Gradio
...
directory=/workspace/Qwen3-TTS/demo
autostart=true
autorestart=true
startsecs=15
